...
`;
  ...
  app.post('/api/spotify/create-playlist', requireAuth, async (req: any, res) => {
    try {
      ...
      const description = `${aiPlaylist.description || `Cosmic playlist for ${aiPlaylist.weekStart} to ${aiPlaylist.weekEnd}`} - Generated by Cosmic Playlist Generator`;
  ...
  app.post('/api/share/playlist/:sessionId', requireAuth, async (req: any, res) => {
    try {
      ...
      try {
        ...
        const description = `${playlist.description || `Cosmic playlist for ${playlist.weekStart} to ${playlist.weekEnd}`} - Generated by Cosmic Playlist Generator`;
